...
<!-- RECOMMENDATION: Create screenshots with French UI, then use these as inspiration for on-screen text -->
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (French) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (French) -->
...
<!-- NOTE: These URLs should work for all languages. Consider adding /fr/ for French pages if you create localized legal docs -->
