# Store Listing - Focus Field (Portuguese)
<!-- LANGUAGE: Portuguese (PT) -->
<!-- MARKETS: Portugal, Brazil -->
<!-- LAST UPDATED: November 11, 2025 -->
<!-- VERSION: 1.1.0 -->
<!-- NOTE: This version uses European Portuguese. For Brazilian Portuguese, see store_listing_pt_BR.md -->
...
```
<!-- TRANSLATION: "Measure Silence, Focus Better" -->
...
```
<!-- TRANSLATION: "Measure ambient silence and build focus habits with our compassionate system" -->
...
<!-- RECOMMENDATION: Create screenshots with Portuguese UI, then use these as inspiration for on-screen text -->
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (Portuguese) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (Portuguese) -->
...
<!-- NOTE: These URLs should work for all languages. Consider adding /pt/ for Portuguese pages if you create localized legal docs -->
