...
<!-- CURRENT LENGTH: ~2200 characters -->
...
<!-- RECOMMENDATION: Create screenshots with German UI, then use these as inspiration for on-screen text -->
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (German) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (German) -->
...
<!-- NOTE: These URLs should work for all languages. Consider adding /de/ for German pages if you create localized legal docs -->
