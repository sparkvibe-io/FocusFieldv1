...
<!-- CURRENT LENGTH: ~1700 characters -->
...
<!-- RECOMMENDATION: Create screenshots with Chinese UI, then use these as inspiration for on-screen text -->
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (Chinese) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (Chinese) -->
