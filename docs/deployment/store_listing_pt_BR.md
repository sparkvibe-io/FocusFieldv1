...
<!-- RECOMMENDATION: Create screenshots with Brazilian Portuguese UI, then use these as inspiration for on-screen text -->
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (Portuguese - Brazil) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (Portuguese - Brazil) -->
...
<!-- NOTE: These URLs should work for all languages. Consider adding /pt-br/ for Brazilian Portuguese pages if you create localized legal docs -->
...
**Best practices for Brazilian market**:
