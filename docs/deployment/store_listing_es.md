...
### App Name
<!-- WHERE TO USE: App Store Connect > App Information > Name -->
<!-- WHERE TO USE: Google Play Console > Store Listing > App name -->
...
```
<!-- TRANSLATION: "Measure Silence, Build Focus" -->
...
<!-- WHERE TO USE: Google Play Console > Store Listing > Full description -->
<!-- CHARACTER LIMIT: 4000 characters max -->
<!-- CURRENT LENGTH: ~2100 characters -->
...
CÓMO FUNCIONA
• Inicia una sesión de concentración (1 minuto a 4 horas)
...
CARACTERÍSTICAS PREMIUM ($0.99/mes o $9.99/año)
• Sesiones extendidas hasta 4 horas (vs 30 min gratis)
• Análisis avanzados y gráficos de tendencias
• Exportación de datos (CSV/PDF)
• Temas premium exclusivos
• Historial de 90 días (vs 7 días gratis)
...
IDIOMAS COMPATIBLES
Inglés, Español, Francés, Alemán, Japonés, Portugués, Portugués Brasileño, Chino (Simplificado)
...
<!-- WHERE TO USE: App Store Connect > Screenshots > Each screenshot has a caption field (optional) -->
<!-- WHERE TO USE: These are primarily for your reference when creating screenshots -->
<!-- RECOMMENDATION: Create screenshots with Spanish UI, then use these as inspiration for on-screen text -->

### Screenshot 1: Home Screen
<!-- ENGLISH: "Start Your Focus Session" -->
...
<!-- ENGLISH: "Track ambient silence in real-time with our intuitive progress ring" -->

### Screenshot 2: Active Session
<!-- ENGLISH: "Real-Time Ambient Monitoring" -->
...
<!-- ENGLISH: "Adjust activities, goals, and themes to fit your workflow" -->

### Screenshot 8: Onboarding
<!-- ENGLISH: "Get Started in Seconds" -->
**Title**: "Comienza en Segundos"
**Description**: "La incorporación intuitiva te guía a través de la configuración"
<!-- ENGLISH: "Intuitive onboarding guides you through setup" -->

---

## 🔑 Keywords

<!-- WHERE TO USE: App Store Connect > App Information > Keywords -->
<!-- CHARACTER LIMIT: 100 characters (comma-separated, no spaces after commas) -->
<!-- NOTE: App Store uses one keyword field; Google Play has changed to let Google auto-generate from description -->

```
concentración,productividad,silencio,ambiente,ruido,meditación,estudio,trabajo profundo,enfoque
```
<!-- ENGLISH: focus,productivity,silence,ambient,noise,meditation,study,deep work,concentration -->
...
```
¡Primer rastreador de silencio ambiental! Sistema de misiones. Sin grabación - solo mediciones. Privacidad primero.
```
...
<!-- CHARACTER LIMIT: 4000 characters (both platforms) -->
...
PREMIUM ($0.99/mes o $9.99/año)
Actualiza para obtener sesiones de hasta 4 horas, análisis avanzados, exportación de datos y temas exclusivos.
...
<!-- WHERE TO USE: App Store Connect > Subscriptions > Premium Monthly > Localization (Spanish) -->
<!-- WHERE TO USE: Google Play Console > Subscriptions > premium.tier.monthly > Store Listing (Spanish) -->

**Display Name**:
<!-- FIELD: Subscription Display Name -->
```
Premium
```
...
```
Desbloquea funciones Premium ($0.99/mes o $9.99/año):
• Sesiones extendidas (hasta 4 horas vs 30 min gratis)
• Análisis avanzados y gráficos de tendencias
• Exportación de datos (CSV/PDF)
• Temas premium exclusivos
...
<!-- WHERE TO USE: Google Play Console > Subscriptions > Benefits -->
<!-- NOTE: Each benefit is a separate line -->
```
Sesiones extendidas
Análisis avanzados
...
<!-- NOTE: These URLs should work for all languages. Consider adding /es/ for Spanish pages if you create localized legal docs -->
