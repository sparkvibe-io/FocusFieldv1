# Store Listing - English (NO EMOJI VERSION)

**Last Updated**: October 26, 2025
**Important**: This version has NO EMOJI characters - safe for App Store Connect & Google Play Console
**Use this file**: Copy text from here to avoid "invalid characters" errors
...
### App Name
<!-- WHERE TO USE: Both platforms > App Information > App Name -->
...
```
Track ambient silence. Build focus habits. Deep work in 4-hour sessions.
```
...
• Meditators (quiet environment tracking)
...
• Per-activity tracking: Study, Reading, Meditation
• 12-week activity heatmap
• Beautiful Material 3 design with 10 themes
• 7 languages supported
...
Track ambient silence with our intuitive progress ring. Choose 30 minutes (free) or up to 4 hours (Premium).
```

**Screenshot 2: Active Session**
```
Real-Time Ambient Monitoring
Watch your Calm% update live as you maintain focus. 70% threshold rewards genuine quiet time.
```

**Screenshot 3: Today Tab**
```
Track Daily Progress
Separate tracking for Study, Reading, and Meditation. Set goals up to 18 hours per activity.
```

**Screenshot 4: Quest Progress**
```
Build Compassionate Streaks
5-day streak with 2-day rule. Monthly Freeze Token protects tough days. Progress, not perfection.
```

**Screenshot 5: Focus Mode**
```
Minimize Distractions
Full-screen Focus Mode for deep work. Long-press Pause/Stop controls. Escape with intention.
```

**Screenshot 6: Analytics**
```
Visualize Your Journey
12-week activity heatmap and performance trends. Premium: 90-day history with advanced insights.
```

**Screenshot 7: Settings**
```
Customize Your Experience
Adjust activities, goals, and themes. Choose from 10 beautiful themes (7 exclusive to Premium).
```

**Screenshot 8: Premium / Paywall**
```
Unlock Premium Features
4-hour sessions • Advanced analytics • Data export • Ad-free • Exclusive themes • 90-day history
```
...
1. **Open this file** (store_listing_en_NO_EMOJI.md)
2. **Copy the text** from the code blocks
3. **Paste directly** into App Store Connect / Google Play Console
4. **No errors!** ✅

The text maintains the same great vibe and energy—just without the emoji characters that cause validation errors.

---

**All text is now store-compliant!** 🎉 (but you won't see that emoji in the stores 😄)
