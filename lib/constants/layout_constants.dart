...
class LayoutConstants {
  ...
  static const double mediumWidth =
      600; // tablets portrait / large phones landscape
  ...
  static double computeProgressRingSize(
    double maxWidth, {
    ...
    final heightCap =
        availableHeight.isFinite ? availableHeight * 0.6 : double.infinity;
    final candidate =
        heightCap.isFinite ? computed.clamp(0, heightCap) : computed;
