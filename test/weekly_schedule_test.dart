...
void main() {
  ...
  service = NotificationService();
      captured = [];
      service.onZonedSchedule = ({required int id, required DateTime scheduled, required DateTimeComponents? match}) {
      ...
      service.updateSettings(notifications: true, weeklyProgress: true, weeklyWeekday: DateTime.friday, weeklyHour: 12, weeklyMinute: 0);
    });
